...
$_id = $_GET['id'];
$_select = "SELECT * FROM why_us where id ='$_id'";
...
<div class="container">
  ...
  <div class="card col-10 mx-auto mt-5 px-0 shadow-lg rounded">
    ...
    <div class="card-body" style="background: #49596d;">
      <form action="./controller_why_us/update_why_us.php" method="POST" enctype="multipart/form-data">

        <input type="hidden" name="id" id="" value="<?= $_fetch['id'] ?>">

        <div class="mb-3">
          <input type="text" name="title_one" class="form-control  my-3" value="<?= $_fetch['title_one'] ?>" placeholder="Title_one">
        ...
        <div class="mb-3">
          ...
          <textarea name="text_one" class="form-control  my-3"><?= $_fetch['text_one'] ?></textarea>
          <span class="text-danger">
        ...
        <div class="mb-3">
          <input type="text" name="icon_one" class="form-control my-3" value="<?= $_fetch['icon_one'] ?>" placeholder="Icon_one">
          <span class="text-danger">
        ...
        <div class="mb-3">
          <input type="text" name="title_two" class="form-control  my-3" value="<?= $_fetch['title_two'] ?>" placeholder="Title_two">
          <span class="text-danger">
        ...
        <div class="mb-3">
          <label class="text-white">Description Two</label>
          <textarea name="text_two" class="form-control  my-3"> <?= $_fetch['text_two'] ?> </textarea>
          <span class="text-danger">
        ...
        <div class="mb-3">
          <input type="text" name="icon_two" class="form-control my-3" value="<?= $_fetch['icon_two'] ?>" placeholder="Icon_two">
          <span class="text-danger">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="video_link" class="form-control my-3" value="<?= $_fetch['video_link'] ?>" placeholder="video_link">
          <span class="text-danger">
